...
const paths: Record<string, string> = {
  ...
  settings:
    'M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7 M19.4 15a1.7 1.7 0 0 0 .34 1.87l.06.06-1.7 2.94-.08-.03a1.7 1.7 0 0 0-1.84.31l-.06.05h-3.4l-.02-.08a1.7 1.7 0 0 0-1.29-1.31l-.08-.02-1.7-2.94.06-.06A1.7 1.7 0 0 0 10 14l-.03-.08v-3.4L10 10.5a1.7 1.7 0 0 0 1.31-1.29l.02-.08h3.4l.06.05a1.7 1.7 0 0 0 1.84.31l.08-.03 1.7 2.94-.06.06a1.7 1.7 0 0 0-.34 1.87l.03.08v.51z M8.2 7.1 7.7 4.6l3.2-1.8 1.8 1.8 2.6-.1 1-2.3 3.5.8.2 2.5 1.8 1.8-.6 2.5',
};
@Component({
  selector: 'app-icon',
  standalone: true,
